...
const Container = Styled.ScrollView`flex: 1; background-color: #141414;`;
const LoadingContainer = Styled.View`flex: 1; backgorund-color: #141414; align-items: center; justify-content: center; `;
const ContainerTtitle = Styled.Text`font-size: 16px; color: #FFFFFF; font-weight: bold; padding: 24px 16px 8px 16px;`;
const DescriptionContainer = Styled.View``;
const Description = Styled.Text`padding: 0 16px; color: #FFFFFF;`;
const SubInfoContainer = Styled.View``;
const InfoContainer = Styled.View`flex-direction: row 
justify-content: space-between; padding: 0 16px; `;
const LabelInfo = Styled.Text`color: #FFFFFF;`;
...
const MovieDetail = ({navigation}: Props) => {
  ...
  return data ? (
    <Container>
      ...
      />
      <SubInfoContainer>
        <ContainerTtitle>영화 정보</ContainerTtitle>
        <InfoContainer>
      ...
      <DescriptionContainer>
        <ContainerTtitle>줄거리</ContainerTtitle>
